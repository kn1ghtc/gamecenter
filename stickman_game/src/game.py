...
class Game:
    ...
    def draw(self, screen):
        ...
        goal_text = get_chinese_font(text_size).render("目标", True, BLACK)
    ...
    def draw_ui(self, screen):
        ...
        if is_fullscreen:
            ...
            detail_font = get_chinese_font(14)
        ...
        if is_fullscreen:
            ...
            performance_text = get_chinese_font(14).render(f"FPS: {fps}", True, WHITE)
